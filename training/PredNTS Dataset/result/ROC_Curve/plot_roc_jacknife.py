...
y_test_KNN = pd.read_csv(result_path + "KNN\\y_test_jackknife.csv", index_col=[0])
y_test_RF = pd.read_csv(result_path + "RF\\y_test_jackknife.csv", index_col=[0])
y_test_SVM = pd.read_csv(result_path + "SVM\\y_test_jackknife.csv", index_col=[0])

y_pred_KNN = pd.read_csv(result_path + "KNN\\y_pred_jackknife.csv", index_col=[0])
y_pred_RF = pd.read_csv(result_path + "RF\\y_pred_jackknife.csv", index_col=[0])
y_pred_SVM = pd.read_csv(result_path + "SVM\\y_pred_jackknife.csv", index_col=[0])
...
plt.title("ROC curve of classifiers for jackknife")
plt.legend(loc="lower right")
plt.show()
# plt.savefig(fname=result_path + "\\ROC_jackknife.eps")