...
path= r'F:\recent_research_topics\nitrotyrosine\pNitro-Tyr-PseAAC\fold_index'
y_ace = []
for i in range(1151):
    y_ace.append(1);
for i in range(7666):
...
train_df.to_csv(path+'\\train_index_LOO.csv', index=None, header=None)
test_df.to_csv(path+'\\test_index_LOO.csv', index=None, header=None)